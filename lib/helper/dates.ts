...
import { endOfMonth, formatDistanceToNow, intervalToDuration, startOfMonth } from "date-fns";

export function DatesToDurationString(end: Date | null | undefined, start: Date | null | undefined): string | null {
